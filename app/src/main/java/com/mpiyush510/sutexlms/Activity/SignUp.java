...
MaterialDatePicker<Long> materialDatePicker;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        arrayAdapter=new ArrayAdapter<String>(SignUp.this, R.layout.list_item,SyBcaRno);
        binding.Rno.setAdapter(arrayAdapter);
        arrayAdapter=new ArrayAdapter<String>(SignUp.this,R.layout.list_item,SyBcaDivision);
        binding.Division.setAdapter(arrayAdapter);
        binding.Rno.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            @Override
        ...
        binding.Division.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            @Override
            public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
    ...
    private boolean isValid(){
        if(binding.FirstName.getText().toString().isEmpty()){
            ...
            showToast("Choose Your Rno");
            return false;
        } else if (binding.Division.getText().toString().isEmpty()) {
            showToast("Choose your Division");
            return false;
        } else if (binding.Sid.getText().toString().isEmpty()) {
            showToast("Enter Your Student ID");
            return false;
        }else if (binding.Sid.getText().toString().length() <6 ) {
            showToast("Sid Must be 6 Digit");
            return false;
        } else{
            return true;
        }
